...
class PPO:
    ...
    def train_loop(self, buffer_size=2048, minimal_buffer_size=128, batch_size=64, instance_list=None,
        ...
        val_final_makespan.T.to_csv('D:/记录/课程、比赛/研二/HR_based DRL in JSRS/val_data_makespan.csv')
        val_final_trantime.T.to_csv('D:/记录/课程、比赛/研二/HR_based DRL in JSRS/val_data_trantime.csv')
